...
public class BacklogController {
    ...
    public ResponseEntity<?> getProjectTask(@PathVariable String backlog_id, @PathVariable String task_id){
        ProjectTask projectTask = projectTaskService.findTaskByProjectSequence(backlog_id, task_id);
    ...
    public ResponseEntity<?> updateProjectTask(@Valid @RequestBody ProjectTask projectTask, BindingResult result,
        ...
        ProjectTask updatedTask = projectTaskService.updateByProjectSequence(projectTask, backlog_id, task_id);
    ...
    public ResponseEntity<?> deleteProjectTask(@PathVariable String backlog_id, @PathVariable String task_id){
        projectTaskService.deleteTaskByProjectSequence(backlog_id, task_id);
        return new ResponseEntity<String>("Project task '" + task_id + "' was deleted sucessfully", HttpStatus.OK);
    }
}
